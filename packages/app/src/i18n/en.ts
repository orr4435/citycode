...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by CODE-CAL",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CODE-CAL.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CODE-CAL.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CODE-CAL.",
  ...
  "dialog.server.description": "Switch which CODE-CAL server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "CODE-CAL",
  ...
  "wsl.onboarding.checkingOpencode": "Checking CODE-CAL...",
  "wsl.onboarding.checkingOpencodeIn": "Checking CODE-CAL in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating CODE-CAL...",
  "wsl.onboarding.updatingOpencodeIn": "Updating CODE-CAL in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update CODE-CAL in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update CODE-CAL",
  "wsl.onboarding.opencodeReadyIn": "CODE-CAL is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "CODE-CAL is ready.",
  "wsl.onboarding.installOpencodeIn": "Install CODE-CAL in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install CODE-CAL",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CODE-CAL not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before CODE-CAL can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "CODE-CAL could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen CODE-CAL.",
  ...
  "help.tabs.introduction": "CODE-CAL Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of CODE-CAL ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the CODE-CAL team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CODE-CAL does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CODE-CAL includes free models so you can start immediately.",
  ...
  "app.name.desktop": "CODE-CAL Desktop",
  ...
  "settings.desktop.wsl.description": "Run the CODE-CAL server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for CODE-CAL",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how CODE-CAL looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether CODE-CAL follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CODE-CAL is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CODE-CAL launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CODE-CAL.",
