...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by CityCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CityCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CityCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CityCode.",
  ...
  "dialog.server.description": "Switch which CityCode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "CityCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking CityCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking CityCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating CityCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating CityCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update CityCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update CityCode",
  "wsl.onboarding.opencodeReadyIn": "CityCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "CityCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install CityCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install CityCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "CityCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before CityCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "CityCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen CityCode.",
  ...
  "help.tabs.introduction": "CityCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of CityCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the CityCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CityCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CityCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "CityCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the CityCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for CityCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how CityCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether CityCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CityCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CityCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CityCode.",
