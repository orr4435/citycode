...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "CODE-CAL failed to load",
  "desktop.recovery.terminated": "CODE-CAL window terminated unexpectedly",
  "desktop.recovery.unresponsive": "CODE-CAL is not responding",
  ...
  "desktop.wsl.error.installOpencode": "CODE-CAL installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CODE-CAL is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CODE-CAL update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
