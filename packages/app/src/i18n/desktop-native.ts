...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "CityCode failed to load",
  "desktop.recovery.terminated": "CityCode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "CityCode is not responding",
  ...
  "desktop.wsl.error.installOpencode": "CityCode installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "CityCode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CityCode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
